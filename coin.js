...
//     const remFrmFavBtn = document.getElementById('remove-to-fav-btn');
...
//         remFrmFavBtn.textContent = favorites.includes(coinId) ? 'Remove from Ravorites' : 'Add to Favorites'
//     };

//     remFrmFavBtn.addEventListener('click', toggleFavorite);
